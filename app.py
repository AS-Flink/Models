...
def create_horizontal_diagram_with_icons(situation_name, icons_b64):
    ...
    #         f'<path d="M {POS["meter_pv"][0]+100} {POS["meter_pv"][1]+40} C 700 120, 700 330, {POS["meter_battery"][0]+100} {POS["meter_battery"][1]+40}" {direct_use_arrow} />'
    #     ])
        ...
        lines_to_draw.extend([
            ...
            f'<path d="M {POS["meter_pv"][0]} {POS["meter_pv"][1]+20} L {POS["meter_pv"][0]-70} {POS["meter_pv"][1]+20} L {POS["meter_pv"][0]-70} {POS["battery"][1]+60} L {POS["meter_battery"][0]} {POS["battery"][1]+60}" {direct_use_arrow} />'
        ])
