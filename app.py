...
def create_horizontal_diagram_with_icons(situation_name, icons_b64):
    ...
    #     ])
        ...
        lines_to_draw.extend([
            ...
            # 2. PV Meter -> PAP
            f'<path d="M {POS["meter_pv"][0]+55} {POS["meter_pv"][1]+80} L 570 145 L {POS["load"][0]+50} 150 L {POS["load"][0]+50} {POS["load"][1]}" {arrow} />',
            ...
            f'<path d="M {POS["meter_pv"][0]+45} {POS["meter_pv"][1]+80} L 570 145 L {POS["load"][0]+50} 150 L {POS["load"][0]+50} {POS["load"][1]}" {direct_use_arrow} />'
        ])
