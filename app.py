...
def show_model_page():
    ...
    # --- Sidebar for Inputs ---
    with st.sidebar:
        st.image("<a href='https://postimg.cc/CBn33xqb' target='_blank'><img src='https://i.postimg.cc/RFgvn3Cp/LOGO-S-PRESENTATIE.webp' border='0' alt='LOGO-S-PRESENTATIE'/></a>", width=70)
